"""Regression: tak_layer's TAK sender must survive connection churn.
...
def test_tcpsender_survives_reconnect_churn():
    tak_layer.RECONNECT_S = 0.02  # many reconnect cycles inside the window
    ...
    sender = tak_layer.TcpSender([("127.0.0.1", port)], tls=False)

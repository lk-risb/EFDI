...
_SOURCE_BRIDGES=(meteolt
                 dronuradaras sitaware asterix-bridge udp-ingress track-fusion mediamtx)
...
_LAYERS=(tak_layer sitaware_layer tak_alert_layer)

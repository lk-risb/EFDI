...
TOPIC_ROOT = prefix() + "/" + ORG   # configurable prefix precedes the pod namespace
...
def run(args):
    ...
    pub = session.declare_publisher("{}/air/icao/rest/neutral/notam/notams/v1".format(TOPIC_ROOT))

...
SERVICE_SPECS = [
    ...
    ("stanag5516", "Protocols", "STANAG 5516 / Link 16 JREAP-C decoder"),
    ("cap", "Protocols", "CAP 1.2 alerts"),
    ("mqtt", "Protocols", "MQTT sensor JSON"),
    ("aartos", "Protocols", "Aaronia AARTOS drone tracking JSON"),
    ...
    ("aartos-raw", "Raw ingress", "Aaronia AARTOS HTTP stream ingress (drone/airframe block)"),
    ...
    ("tak_alert_layer", "C2 outputs", "Emergency squawk / ship distress → TAK GeoChat (opt-in)"),
...
# The two C2 layers (tak_layer -> TAK, sitaware_layer -> SitaWare) live in layers/,
...
EDITABLE_EXACT = {
    ...
    "TAK_HOST", "TAK_HOST_FALLBACK", "TAK_HOST_TAILSCALE", "TAK_PORT", "TAK_TLS", "TAK_TLS_SERVER_NAME",
    "TAK_CERT", "TAK_KEY", "TAK_CA",
    "SITAWARE_URL", "SITAWARE_URL_FALLBACK", "SITAWARE_URL_TAILSCALE", "SITAWARE_API_PATH", "SITAWARE_USER", "SITAWARE_PASS", "SITAWARE_POLL_S",
    ...
    "SITAWARE_HQ_NVG_STALE_S", "SITAWARE_HQ_NVG_MAX_TRACKS",
    "SITAWARE_HQ_NVG_ALLOW_ANONYMOUS", "SITAWARE_HQ_NVG_ALLOW_INSECURE_HTTP",
    "MAINLINE_TERMINAL_URL", "MAINLINE_TERMINAL_USER", "MAINLINE_TERMINAL_PASS",
    "MAVLINK_ENDPOINT",
    ...
    "STANAG4609_VIDEO_RELAY_ENABLE", "STANAG4609_VIDEO_PATH",
    "CAP_INPUT_TOPIC", "CAP_ACTIVE_ONLY",
    "SENSOR_HEALTH_INPUT_TOPIC", "MISSION_ROUTE_INPUT_TOPIC",

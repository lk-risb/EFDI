...
import {
  LayoutDashboard, FileCog, ShieldUser, LogOut, Menu, Settings, Sun, Moon, Bell
} from 'lucide-react'
...
function ChangePasswordFields({ onClose }: { onClose: () => void }) {
  ...
  return (
    <div className="flex h-screen bg-zinc-50 dark:bg-[#000000] text-zinc-900 dark:text-zinc-100 hud-grid-bg">
      ...
      <aside className={cn(
        ...
        <div className="px-3 py-3 border-t border-zinc-200 dark:border-white/10 flex items-center gap-2">
          ...
          <button
            ...
            className="ml-auto p-1.5 rounded hover:bg-zinc-200 dark:hover:bg-[#1a1a1d] text-zinc-600 dark:text-zinc-400 focus:outline-none focus:ring-2 focus:ring-accent-ring"
          >

#!/usr/bin/env python3
"""Link 16 / JREAP-C gateway protocol → Zenoh.
...
Run:
    venv/bin/python3 protocols/link16.py
    venv/bin/python3 protocols/link16.py --port 3010 --verbose
"""
...
def run_zenoh_raw(raw_topic: str, verbose: bool):

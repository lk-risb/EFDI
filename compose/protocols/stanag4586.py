#!/usr/bin/env python3
"""STANAG 4586 UAS interface protocol (CUCS side) → Zenoh.
...
Run:
  venv/bin/python3 protocols/stanag4586.py --host 192.168.1.50 --port 4586
"""
    ...
    def on_sample(sample):
        try:
            ...
            while len(buffer) >= HEADER_SIZE:
                ...
                if total_size < HEADER_SIZE or total_size > 1_048_576:
                    del buffer[0]
                    continue
